...
export default function ChatScreen() {
  ...
  // Check authentication - but don't redirect since this is now a tab
  useEffect(() => {
    if (!isSignedIn) {
      // Just show the authentication required view instead of alert
      console.log('User not signed in - showing auth required view');
    }
  }, [isSignedIn]);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        {/* Header - simplified since this is now a tab */}
